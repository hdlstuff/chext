...
object Zip {
  def apply[T1 <: Data](rv1: Interface[T1]) = {
    val rv = wrap(WireBundleN(rv1.bits))
  ...
  def apply[T1 <: Data, T2 <: Data](
    ...
    val rv = wrap(WireBundleN(rv1.bits, rv2.bits))
  ...
  def apply[T1 <: Data, T2 <: Data, T3 <: Data](
    ...
    val rv = wrap(WireBundleN(rv1.bits, rv2.bits, rv3.bits))
  ...
  def apply[T1 <: Data, T2 <: Data, T3 <: Data, T4 <: Data](
    ...
    val rv = wrap(WireBundleN(rv1.bits, rv2.bits, rv3.bits, rv4.bits))
