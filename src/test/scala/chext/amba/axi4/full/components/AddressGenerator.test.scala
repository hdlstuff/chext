package chext.amba.axi4.full.components.addrgen
...
class AddressGeneratorTest extends chext.test.FreeSpec with chext.test.TestMixin {
  ...
  "chext.amba.axi4.full.components.AddressGenerator.INCR" in
  ...
  "chext.amba.axi4.full.components.AddressGenerator.WRAP" in
    test(new AddressGenerator(wAddr)) { (dut) =>
      {
        dut.source.initSource()
        dut.sink.initSink()
  ...
  "chext.amba.axi4.full.components.AddressGenerator.FIXED" in
    test(new AddressGenerator(wAddr)) { (dut) =>
      {
        dut.source.initSource()
        dut.sink.initSink()
  ...
  "chext.amba.axi4.full.components.AddressStrobeGenerator.INCR (32B)" in
