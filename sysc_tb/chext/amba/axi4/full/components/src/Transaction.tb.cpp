...
std::vector<TransactionTestCase> transactionTestCases {
    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 0, .burst = 0 },
    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 1, .burst = 0 },
    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 2, .burst = 0 },

    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 0, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 1, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 2, .burst = 1 },

    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 0, .burst = 2 },
    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 1, .burst = 2 },
    { .wData = 32 /* 4B */, .addr = 0x0000, .len = 3, .size = 2, .burst = 2 },

    { .wData = 32 /* 4B */, .addr = 0x0001, .len = 3, .size = 0, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0001, .len = 3, .size = 1, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0001, .len = 3, .size = 2, .burst = 1 },

    { .wData = 32 /* 4B */, .addr = 0x0002, .len = 3, .size = 0, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0002, .len = 3, .size = 1, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0002, .len = 3, .size = 2, .burst = 1 },

    { .wData = 32 /* 4B */, .addr = 0x0003, .len = 3, .size = 0, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0003, .len = 3, .size = 1, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0003, .len = 3, .size = 2, .burst = 1 },

    { .wData = 32 /* 4B */, .addr = 0x0005, .len = 3, .size = 0, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0005, .len = 3, .size = 1, .burst = 1 },
    { .wData = 32 /* 4B */, .addr = 0x0005, .len = 3, .size = 2, .burst = 1 },

    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 0, .burst = 0 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 1, .burst = 0 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 2, .burst = 0 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 3, .burst = 0 },

    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 0, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 1, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 2, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 3, .burst = 1 },

    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 0, .burst = 2 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 1, .burst = 2 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 2, .burst = 2 },
    { .wData = 64 /* 8B */, .addr = 0x0000, .len = 3, .size = 3, .burst = 2 },

    { .wData = 64 /* 8B */, .addr = 0x0001, .len = 3, .size = 0, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0001, .len = 3, .size = 1, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0001, .len = 3, .size = 2, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0001, .len = 3, .size = 3, .burst = 1 },

    { .wData = 64 /* 8B */, .addr = 0x0002, .len = 3, .size = 0, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0002, .len = 3, .size = 1, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0002, .len = 3, .size = 2, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0002, .len = 3, .size = 3, .burst = 1 },

    { .wData = 64 /* 8B */, .addr = 0x0003, .len = 3, .size = 0, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0003, .len = 3, .size = 1, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0003, .len = 3, .size = 2, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0003, .len = 3, .size = 3, .burst = 1 },

    { .wData = 64 /* 8B */, .addr = 0x0005, .len = 3, .size = 0, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0005, .len = 3, .size = 1, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0005, .len = 3, .size = 2, .burst = 1 },
    { .wData = 64 /* 8B */, .addr = 0x0005, .len = 3, .size =  3, .burst = 1 }
};
