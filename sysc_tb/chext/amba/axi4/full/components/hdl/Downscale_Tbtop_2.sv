...
module Downscale(
  ...
  wire         _GEN;
  wire [1:0]   _write_offsetLastQueue_ram_dataOutB;
  ...
  wire [1:0]   _read_offsetLastQueue_ram_dataOutB;
  wire         _read_addressGenerator_source_ready;
  ...
  wire         read_offsetLastQueue_source_bits__1;
  ...
  wire         read_offsetLastQueue_sink_bits__1 = _read_offsetLastQueue_ram_dataOutB[1];
  ...
  assign read_offsetLastQueue_source_bits__1 = _read_addressGenerator_sink_bits_addr[3];
  ...
  wire         write_offsetLastQueue_source_bits__1;
  ...
  wire         write_offsetLastQueue_sink_bits__1 =
    _write_offsetLastQueue_ram_dataOutB[1];
  ...
  assign write_offsetLastQueue_source_bits__1 = _write_addressGenerator_sink_bits_addr[3];
