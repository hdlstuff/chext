...
// VCS coverage exclude_file
module write_mem_64x3(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:222:18
  input  [5:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [2:0] R0_data,
  ...
  reg [2:0] Memory[0:63];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:222:18
    ...
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:222:18
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:222:18
        for (logic [6:0] i = 7'h0; i < 7'h40; i += 7'h1) begin
          ...
          Memory[i[5:0]] = _RANDOM_MEM[2:0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:222:18
...
module IdParallelize(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7
  ...
  write_mem_64x3 write_mem_ext (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:222:18
    ...
    .W0_clk  (clock),
    .W0_data (3'h0),	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:222:18
