...
// VCS coverage exclude_file
module mem_256x67(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:94:18
  input  [7:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [66:0] R0_data,
  ...
  reg [66:0] Memory[0:255];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:94:18
    ...
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:94:18
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:94:18
        for (logic [8:0] i = 9'h0; i < 9'h100; i += 9'h1) begin
          ...
          Memory[i[7:0]] = _RANDOM_MEM[66:0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:94:18
        end	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:94:18
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
...
module SyncWriteElasticReadMemory(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:40:15
  ...
  mem_256x67 mem_ext (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:94:18
