...
module IdSerialize(
  ...
  wire        _GEN;
  wire        _write_fork0_result_valid_T;
  wire [46:0] _read_fork0_repeat0_leftBuffer0_ram_dataOutB;
  wire [3:0]  read_fork0_repeat0_leftBuffer0_source_bits_id = s_axi_ar_bits_id;
  wire [13:0] read_fork0_repeat0_leftBuffer0_source_bits_addr = s_axi_ar_bits_addr;
  wire [7:0]  read_fork0_repeat0_leftBuffer0_source_bits_len = s_axi_ar_bits_len;
  ...
  wire        read_fork0_repeat0_leftBuffer0_ptr_match =
    read_fork0_repeat0_leftBuffer0_enq_ptr_value == read_fork0_repeat0_leftBuffer0_deq_ptr_value;
  wire        read_fork0_repeat0_leftBuffer0_empty =
    read_fork0_repeat0_leftBuffer0_ptr_match & ~read_fork0_repeat0_leftBuffer0_maybe_full;
  wire        read_fork0_repeat0_leftBuffer0_source_valid;
  wire        read_fork0_repeat0_leftBuffer0_sink_valid =
    read_fork0_repeat0_leftBuffer0_source_valid | ~read_fork0_repeat0_leftBuffer0_empty;
  wire [3:0]  read_fork0_repeat0_leftBuffer0_sink_bits_id =
    read_fork0_repeat0_leftBuffer0_empty
      ? read_fork0_repeat0_leftBuffer0_source_bits_id
      : _read_fork0_repeat0_leftBuffer0_ram_dataOutB[46:43];
  wire [13:0] read_fork0_repeat0_leftBuffer0_sink_bits_addr =
    read_fork0_repeat0_leftBuffer0_empty
  ...
  wire        read_fork0_repeat0_leftBuffer0_do_enq =
    ~(read_fork0_repeat0_leftBuffer0_empty & read_fork0_repeat0_leftBuffer0_sink_ready)
    & read_fork0_repeat0_x1_ready & read_fork0_repeat0_leftBuffer0_source_valid;
  ...
  wire        read_fork0_ready_qual1_1 = m_axi_ar_ready | read_fork0_regs_1;
  wire        read_fork0_ready = read_fork0_ready_qual1_0 & read_fork0_ready_qual1_1;
  assign read_fork0_repeat0_leftBuffer0_source_valid =
    s_axi_ar_valid & ~read_fork0_regs_0;
  wire        write_join0_allValid =
    m_axi_b_valid & s_axi_aw_valid & _write_fork0_result_valid_T;
  wire        write_join0_fire = s_axi_b_ready & write_join0_allValid;
  reg         write_fork0_regs_0;
  reg         write_fork0_regs_1;
  wire        write_fork0_ready_qual1_0 = write_join0_fire | write_fork0_regs_0;
  wire        write_fork0_ready_qual1_1 = m_axi_aw_ready | write_fork0_regs_1;
  wire        write_fork0_ready = write_fork0_ready_qual1_0 & write_fork0_ready_qual1_1;
  assign _write_fork0_result_valid_T = ~write_fork0_regs_0;
  wire        read_join0_allValid =
    m_axi_r_valid & read_fork0_repeat0_leftBuffer0_sink_valid & _GEN;
  wire        read_join0_fire = s_axi_r_ready & read_join0_allValid;
  reg  [8:0]  read_fork0_repeat0_count_state;
  reg         read_fork0_repeat0_count_valid;
  wire [8:0]  _read_fork0_repeat0_count_nextState_T =
    read_fork0_repeat0_count_state + 9'h1;
  wire [8:0]  _GEN_0 = {1'h0, read_fork0_repeat0_leftBuffer0_sink_bits_len};
  ...
  assign read_fork0_repeat0_leftBuffer0_sink_ready =
    read_fork0_repeat0_leftBuffer0_sink_valid
    & (read_fork0_repeat0_count_valid
         ? _read_fork0_repeat0_count_T_2 & read_join0_fire
         : ~(|_read_fork0_repeat0_count_T_6) | _read_fork0_repeat0_count_T_8
           & read_join0_fire);
  assign _GEN = read_fork0_repeat0_count_valid | (|_read_fork0_repeat0_count_T_6);
  always @(posedge clock) begin
    automatic logic _GEN_1;
    _GEN_1 = ~(|_read_fork0_repeat0_count_T_6) | _read_fork0_repeat0_count_T_8;
    if (reset) begin
      read_fork0_repeat0_leftBuffer0_enq_ptr_value <= 2'h0;
      read_fork0_repeat0_leftBuffer0_deq_ptr_value <= 2'h0;
      read_fork0_repeat0_leftBuffer0_maybe_full <= 1'h0;
      ...
      if (read_fork0_repeat0_leftBuffer0_sink_valid) begin
        if (read_fork0_repeat0_count_valid)
          ...
          read_fork0_repeat0_count_valid <= ~_GEN_1 & read_join0_fire;
      end
    end
    if (read_fork0_repeat0_leftBuffer0_sink_valid) begin
      if (read_fork0_repeat0_count_valid) begin
      ...
      else if (_GEN_1 | ~read_join0_fire) begin
      end
      else
        read_fork0_repeat0_count_state <= 9'h1;
    end
  ...
  assign s_axi_ar_ready = read_fork0_ready;
  assign s_axi_r_bits_id = read_fork0_repeat0_leftBuffer0_sink_bits_id;
  ...
  assign s_axi_b_bits_id = s_axi_aw_bits_id;
  ...
  assign m_axi_ar_valid = s_axi_ar_valid & ~read_fork0_regs_1;
  assign m_axi_r_ready = read_join0_fire;
