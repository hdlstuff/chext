...
module IdSerialize(
  ...
  wire [7:0]  read_fork0_repeat0_x1_bits_len = s_axi_ar_bits_len;
  wire [2:0]  read_fork0_repeat0_x1_bits_size = s_axi_ar_bits_size;
  wire [1:0]  read_fork0_repeat0_x1_bits_burst = s_axi_ar_bits_burst;
  wire        read_fork0_repeat0_x1_bits_lock = s_axi_ar_bits_lock;
  wire [3:0]  read_fork0_repeat0_x1_bits_cache = s_axi_ar_bits_cache;
  wire [2:0]  read_fork0_repeat0_x1_bits_prot = s_axi_ar_bits_prot;
  wire [3:0]  read_fork0_repeat0_x1_bits_qos = s_axi_ar_bits_qos;
  wire [3:0]  read_fork0_repeat0_x1_bits_region = s_axi_ar_bits_region;
  wire [3:0]  read_fork0_result_bits_id = s_axi_ar_bits_id;
  wire [13:0] read_fork0_result_bits_addr = s_axi_ar_bits_addr;
  wire [7:0]  read_fork0_result_bits_len = s_axi_ar_bits_len;
  wire [2:0]  read_fork0_result_bits_size = s_axi_ar_bits_size;
  wire [1:0]  read_fork0_result_bits_burst = s_axi_ar_bits_burst;
  wire        read_fork0_result_bits_lock = s_axi_ar_bits_lock;
  wire [3:0]  read_fork0_result_bits_cache = s_axi_ar_bits_cache;
  wire [2:0]  read_fork0_result_bits_prot = s_axi_ar_bits_prot;
  wire [3:0]  read_fork0_result_bits_qos = s_axi_ar_bits_qos;
  wire [3:0]  read_fork0_result_bits_region = s_axi_ar_bits_region;
  wire        read_fork0_result_ready = m_axi_ar_ready;
  wire [3:0]  write_fork0_result_bits = s_axi_aw_bits_id;
  wire [3:0]  write_fork0_result_1_bits_id = s_axi_aw_bits_id;
  wire [13:0] write_fork0_result_1_bits_addr = s_axi_aw_bits_addr;
  wire [7:0]  write_fork0_result_1_bits_len = s_axi_aw_bits_len;
  wire [2:0]  write_fork0_result_1_bits_size = s_axi_aw_bits_size;
  wire [1:0]  write_fork0_result_1_bits_burst = s_axi_aw_bits_burst;
  wire        write_fork0_result_1_bits_lock = s_axi_aw_bits_lock;
  wire [3:0]  write_fork0_result_1_bits_cache = s_axi_aw_bits_cache;
  wire [2:0]  write_fork0_result_1_bits_prot = s_axi_aw_bits_prot;
  wire [3:0]  write_fork0_result_1_bits_qos = s_axi_aw_bits_qos;
  ...
  reg         read_fork0_regs_0;
  reg         read_fork0_regs_1;
  wire        read_fork0_repeat0_x1_ready;
  wire        read_fork0_ready_qual1_0 = read_fork0_repeat0_x1_ready | read_fork0_regs_0;
  wire        read_fork0_ready_qual1_1 = read_fork0_result_ready | read_fork0_regs_1;
  wire        read_fork0_ready = read_fork0_ready_qual1_0 & read_fork0_ready_qual1_1;
  ...
  wire [2:0]  read_fork0_repeat0_sourceBuffer0_queueSink_bits_size =
    read_fork0_repeat0_sourceBuffer0_queue0_empty
      ? read_fork0_repeat0_x1_bits_size
      : _read_fork0_repeat0_sourceBuffer0_queue0_ram_dataOutB[20:18];
  wire [1:0]  read_fork0_repeat0_sourceBuffer0_queueSink_bits_burst =
    read_fork0_repeat0_sourceBuffer0_queue0_empty
      ? read_fork0_repeat0_x1_bits_burst
      : _read_fork0_repeat0_sourceBuffer0_queue0_ram_dataOutB[17:16];
  wire        read_fork0_repeat0_sourceBuffer0_queueSink_bits_lock =
    read_fork0_repeat0_sourceBuffer0_queue0_empty
      ? read_fork0_repeat0_x1_bits_lock
      : _read_fork0_repeat0_sourceBuffer0_queue0_ram_dataOutB[15];
  wire [3:0]  read_fork0_repeat0_sourceBuffer0_queueSink_bits_cache =
    read_fork0_repeat0_sourceBuffer0_queue0_empty
      ? read_fork0_repeat0_x1_bits_cache
      : _read_fork0_repeat0_sourceBuffer0_queue0_ram_dataOutB[14:11];
  wire [2:0]  read_fork0_repeat0_sourceBuffer0_queueSink_bits_prot =
    read_fork0_repeat0_sourceBuffer0_queue0_empty
      ? read_fork0_repeat0_x1_bits_prot
      : _read_fork0_repeat0_sourceBuffer0_queue0_ram_dataOutB[10:8];
  wire [3:0]  read_fork0_repeat0_sourceBuffer0_queueSink_bits_qos =
    read_fork0_repeat0_sourceBuffer0_queue0_empty
      ? read_fork0_repeat0_x1_bits_qos
      : _read_fork0_repeat0_sourceBuffer0_queue0_ram_dataOutB[7:4];
  wire [3:0]  read_fork0_repeat0_sourceBuffer0_queueSink_bits_region =
    read_fork0_repeat0_sourceBuffer0_queue0_empty
  ...
  wire        read_fork0_repeat0_sourceBuffer0_queue0_doEnq =
    ...
    & read_fork0_repeat0_x1_valid;
  assign read_fork0_repeat0_x1_ready =
    read_fork0_repeat0_sourceBuffer0_queueSink_ready
    | ~(read_fork0_repeat0_sourceBuffer0_queue0_ptrMatch
        & read_fork0_repeat0_sourceBuffer0_queue0_maybeFull);
  always @(posedge clock) begin
    ...
    if (read_fork0_repeat0_sourceBuffer0_queueSink_valid) begin
      ...
      else if (_GEN_0 | ~read_wire0_ready) begin
      end
      else
        read_fork0_repeat0_count_state <= 9'h1;
    end
  ...
  assign s_axi_ar_ready = read_fork0_ready;
  assign s_axi_r_bits_id = read_wire0_bits;
  ...
  assign s_axi_b_bits_id = write_wire0_bits;
  assign s_axi_b_valid = write_join0_allValid;
  assign m_axi_ar_bits_addr = read_fork0_result_bits_addr;
  assign m_axi_ar_bits_len = read_fork0_result_bits_len;
  assign m_axi_ar_bits_size = read_fork0_result_bits_size;
  assign m_axi_ar_bits_burst = read_fork0_result_bits_burst;
  assign m_axi_ar_bits_lock = read_fork0_result_bits_lock;
  assign m_axi_ar_bits_cache = read_fork0_result_bits_cache;
  assign m_axi_ar_bits_prot = read_fork0_result_bits_prot;
  assign m_axi_ar_bits_qos = read_fork0_result_bits_qos;
  assign m_axi_ar_bits_region = read_fork0_result_bits_region;
  assign m_axi_ar_valid = read_fork0_result_valid;
  assign m_axi_r_ready = read_wire0_ready;
  assign m_axi_aw_bits_addr = write_fork0_result_1_bits_addr;
  assign m_axi_aw_bits_len = write_fork0_result_1_bits_len;
  assign m_axi_aw_bits_size = write_fork0_result_1_bits_size;
  assign m_axi_aw_bits_burst = write_fork0_result_1_bits_burst;
  assign m_axi_aw_bits_lock = write_fork0_result_1_bits_lock;
  assign m_axi_aw_bits_cache = write_fork0_result_1_bits_cache;
  assign m_axi_aw_bits_prot = write_fork0_result_1_bits_prot;
  assign m_axi_aw_bits_qos = write_fork0_result_1_bits_qos;
  assign m_axi_aw_bits_region = write_fork0_result_1_bits_region;
  assign m_axi_aw_valid = write_fork0_result_1_valid;
  assign m_axi_w_bits_data = s_axi_w_bits_data;
  assign m_axi_w_bits_strb = s_axi_w_bits_strb;
  assign m_axi_w_valid = s_axi_w_valid;
  assign m_axi_b_ready = write_wire0_ready;
endmodule

module IdSerialize_Tbtop_1(
  input         clock,
                reset,
  ...
  output [3:0]  S_AXI_TEST_BID,
  output [1:0]  S_AXI_TEST_BRESP
);

  wire [13:0] _idSerialize_m_axi_ar_bits_addr;
  wire [7:0]  _idSerialize_m_axi_ar_bits_len;
  wire [2:0]  _idSerialize_m_axi_ar_bits_size;
  wire [1:0]  _idSerialize_m_axi_ar_bits_burst;
  wire        _idSerialize_m_axi_ar_bits_lock;
  wire [3:0]  _idSerialize_m_axi_ar_bits_cache;
  wire [2:0]  _idSerialize_m_axi_ar_bits_prot;
  wire [3:0]  _idSerialize_m_axi_ar_bits_qos;
  wire [3:0]  _idSerialize_m_axi_ar_bits_region;
  wire        _idSerialize_m_axi_ar_valid;
  wire        _idSerialize_m_axi_r_ready;
  wire [13:0] _idSerialize_m_axi_aw_bits_addr;
  wire [7:0]  _idSerialize_m_axi_aw_bits_len;
  wire [2:0]  _idSerialize_m_axi_aw_bits_size;
  wire [1:0]  _idSerialize_m_axi_aw_bits_burst;
  wire        _idSerialize_m_axi_aw_bits_lock;
  wire [3:0]  _idSerialize_m_axi_aw_bits_cache;
  wire [2:0]  _idSerialize_m_axi_aw_bits_prot;
  wire [3:0]  _idSerialize_m_axi_aw_bits_qos;
  wire [3:0]  _idSerialize_m_axi_aw_bits_region;
  wire        _idSerialize_m_axi_aw_valid;
  wire [63:0] _idSerialize_m_axi_w_bits_data;
  wire [7:0]  _idSerialize_m_axi_w_bits_strb;
  wire        _idSerialize_m_axi_w_valid;
  wire        _idSerialize_m_axi_b_ready;
  ...
  Axi4FullToReadWriteBridge axiBridge2 (
    .clock                (clock),
    .reset                (reset),
    .s_axi_ar_bits_id     (4'h0),
    .s_axi_ar_bits_addr   (_idSerialize_m_axi_ar_bits_addr),
    .s_axi_ar_bits_len    (_idSerialize_m_axi_ar_bits_len),
    .s_axi_ar_bits_size   (_idSerialize_m_axi_ar_bits_size),
    .s_axi_ar_bits_burst  (_idSerialize_m_axi_ar_bits_burst),
    .s_axi_ar_bits_lock   (_idSerialize_m_axi_ar_bits_lock),
    .s_axi_ar_bits_cache  (_idSerialize_m_axi_ar_bits_cache),
    .s_axi_ar_bits_prot   (_idSerialize_m_axi_ar_bits_prot),
    .s_axi_ar_bits_qos    (_idSerialize_m_axi_ar_bits_qos),
    .s_axi_ar_bits_region (_idSerialize_m_axi_ar_bits_region),
    .s_axi_ar_valid       (_idSerialize_m_axi_ar_valid),
    ...
    .s_axi_r_ready        (_idSerialize_m_axi_r_ready),
    .s_axi_aw_bits_id     (4'h0),
    .s_axi_aw_bits_addr   (_idSerialize_m_axi_aw_bits_addr),
    .s_axi_aw_bits_len    (_idSerialize_m_axi_aw_bits_len),
    .s_axi_aw_bits_size   (_idSerialize_m_axi_aw_bits_size),
    .s_axi_aw_bits_burst  (_idSerialize_m_axi_aw_bits_burst),
    .s_axi_aw_bits_lock   (_idSerialize_m_axi_aw_bits_lock),
    .s_axi_aw_bits_cache  (_idSerialize_m_axi_aw_bits_cache),
    .s_axi_aw_bits_prot   (_idSerialize_m_axi_aw_bits_prot),
    .s_axi_aw_bits_qos    (_idSerialize_m_axi_aw_bits_qos),
    .s_axi_aw_bits_region (_idSerialize_m_axi_aw_bits_region),
    .s_axi_aw_valid       (_idSerialize_m_axi_aw_valid),
    .s_axi_aw_ready       (_axiBridge2_s_axi_aw_ready),
    .s_axi_w_bits_data    (_idSerialize_m_axi_w_bits_data),
    .s_axi_w_bits_strb    (_idSerialize_m_axi_w_bits_strb),
    .s_axi_w_valid        (_idSerialize_m_axi_w_valid),
    .s_axi_w_ready        (_axiBridge2_s_axi_w_ready),
    .s_axi_b_bits_id      (/* unused */),
    .s_axi_b_valid        (_axiBridge2_s_axi_b_valid),
    .s_axi_b_ready        (_idSerialize_m_axi_b_ready),
