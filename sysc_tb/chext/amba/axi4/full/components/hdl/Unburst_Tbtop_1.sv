...
module Unburst(
  ...
  reg  [4:0]  read_ar_fork0_sinkBuffer0_enq_ptr_value;
  reg  [4:0]  read_ar_fork0_sinkBuffer0_deq_ptr_value;
  ...
  reg  [4:0]  write_fork0_sinkBuffer0_enq_ptr_value;
  reg  [4:0]  write_fork0_sinkBuffer0_deq_ptr_value;
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      read_ar_fork0_sinkBuffer0_enq_ptr_value <= 5'h0;
      read_ar_fork0_sinkBuffer0_deq_ptr_value <= 5'h0;
      read_ar_fork0_sinkBuffer0_maybe_full <= 1'h0;
      write_fork0_sinkBuffer0_enq_ptr_value <= 5'h0;
      write_fork0_sinkBuffer0_deq_ptr_value <= 5'h0;
      ...
      if (read_ar_fork0_sinkBuffer0_do_enq)
        read_ar_fork0_sinkBuffer0_enq_ptr_value <=
          read_ar_fork0_sinkBuffer0_enq_ptr_value + 5'h1;
      if (read_ar_fork0_sinkBuffer0_do_deq)
        read_ar_fork0_sinkBuffer0_deq_ptr_value <=
          read_ar_fork0_sinkBuffer0_deq_ptr_value + 5'h1;
      ...
      if (write_fork0_sinkBuffer0_do_enq)
        write_fork0_sinkBuffer0_enq_ptr_value <=
          write_fork0_sinkBuffer0_enq_ptr_value + 5'h1;
      if (write_fork0_sinkBuffer0_do_deq)
        write_fork0_sinkBuffer0_deq_ptr_value <=
          write_fork0_sinkBuffer0_deq_ptr_value + 5'h1;
