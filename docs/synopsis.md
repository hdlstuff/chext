...
<table style="table-layout:fixed;width:100%;">
  ...
  <tbody>
    ...
    <tr id="entry-elastic-interfaces-e-source-like-e-sink-like-e-ewire-like">
      <td style="vertical-align:top;"><code>e.Source.like</code>, <code>e.Sink.like</code>, <code>e.EWire.like</code> <a href="#entry-elastic-interfaces-e-source-like-e-sink-like-e-ewire-like" style="text-decoration:none;" aria-label="Permalink to entry-elastic-interfaces-e-source-like-e-sink-like-e-ewire-like">#</a><div style="margin-top:6px;font-size:0.92em;"><div><a href="../src/main/scala/chext/elastic/Interface.scala" style="text-decoration:none;"><span style="background:#e7f0ff;color:#0b4f9c;padding:2px 6px;border-radius:4px;">Scala</span></a></div></div></td>
    ...
    <tr id="entry-elastic-interfaces-e-source-many-e-sink-many-e-interface-many">
      <td style="vertical-align:top;"><code>e.Source.many</code>, <code>e.Sink.many</code>, <code>e.Interface.many</code> <a href="#entry-elastic-interfaces-e-source-many-e-sink-many-e-interface-many" style="text-decoration:none;" aria-label="Permalink to entry-elastic-interfaces-e-source-many-e-sink-many-e-interface-many">#</a><div style="margin-top:6px;font-size:0.92em;"><div><a href="../src/main/scala/chext/elastic/Interface.scala" style="text-decoration:none;"><span style="background:#e7f0ff;color:#0b4f9c;padding:2px 6px;border-radius:4px;">Scala</span></a></div></div></td>
